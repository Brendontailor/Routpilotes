/* Recurso RoutePilot: ações do ponto selecionado. */
/** Guia: Executa uma etapa auxiliar em ações do ponto selecionado (`mapPointMenuHtml`). */
...
/** Guia: Exibe o conteúdo solicitado em ações do ponto selecionado (`openMapPointMenu`). */
...
/** Guia: Executa uma etapa auxiliar em ações do ponto selecionado (`focusMapCoordinates`). */
